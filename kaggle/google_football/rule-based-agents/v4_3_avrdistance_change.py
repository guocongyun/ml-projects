...
def get_average_distance_to_opponents(obs, player_x, player_y, distance=0.03):
    ...
    for i in range(1, len(obs["right_team"])):
        ...
        if obs["right_team"][i][0] > (player_x - 0.02) or (obs["right_team"][i][1]*player_y > 0 and abs(player_x-obs["right_team"][i][1]) < 0.01):
        ...
        for i in range(1, len(obs["right_team"])):
            ...
            if distance_to_opponent < 0.03:
                for j in range(1, len(obs["left_team"])):
                    player_to_opponents = get_average_distance_to_opponents(obs, player_x, player_y, distance=0.03)
                    teammate_to_opponents = get_average_distance_to_opponents(obs, player_x, player_y, distance=0.03)
    ...
    def environment_fits(obs, player_x, player_y):
        ...
        for i in range(1, len(obs["right_team"])):
            ...
            if distance_to_opponent < 0.06 and distance_to_opponent > 0.03:
                for j in range(1, len(obs["left_team"])):
                    player_to_opponents = get_average_distance_to_opponents(obs, player_x, player_y, distance=0.06)
                    teammate_to_opponents = get_average_distance_to_opponents(obs, player_x, player_y, distance=0.06)
                    distance_to_teammate = get_distance(player_x, player_y, obs["left_team"][j][0], obs["left_team"][j][1])
    ...
    def environment_fits(obs, player_x, player_y):
        ...
        for i in range(1, len(obs["right_team"])):
            ...
            if distance_to_opponent > 0.06 and distance_to_opponent < 0.09:
                for j in range(1, len(obs["left_team"])):
                    player_to_opponents = get_average_distance_to_opponents(obs, player_x, player_y, distance=0.09)
                    teammate_to_opponents = get_average_distance_to_opponents(obs, player_x, player_y, distance=0.09)
                    distance_to_teammate = get_distance(player_x, player_y, obs["left_team"][j][0], obs["left_team"][j][1])
