    ...
    def environment_fits(obs, berzerker_x, berzerker_y):
        ...
        if obs["left_team_yellow_card"][obs["active"]] != 1:
            if obs["ball_owned_team"] == 1:
                ...
                distance_to_prey = normal_get_distance(berzerker_x, berzerker_y, prey_x, prey_y)
                future_distance_to_prey = normal_get_distance(future_berzerker_x, future_berzerker_y, future_prey_x, future_prey_y)
