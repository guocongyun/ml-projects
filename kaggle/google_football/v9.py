...
def distance_to_corner(obs, player_x, player_y, steps=0):
    ...
    if future_y < 0:
        distances_score = 10**(1-distance_to_corner_up+unit_steps) + 10**(1-distance_to_self_corner_up+unit_steps)/2 + 10**(1-distance_to_goal_mid+unit_steps)/2
    if future_y >= 0: 
        distances_score = 10**(1-distance_to_corner_down+unit_steps) + 10**(1-distance_to_self_corner_down+unit_steps)/2 + 10**(1-distance_to_goal_mid+unit_steps)/2
    return distances_score
