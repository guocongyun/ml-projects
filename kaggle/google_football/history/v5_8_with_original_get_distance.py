...
def check_block(obs, player_x, player_y, teammate_x, teammate_y, speed=PASS_SPEED):
    ...
    for step in range(steps):
        ...
        for opponent in range(0, len(obs["right_team"])):
            distance_to_opponent = get_distance(ball_pos[0], ball_pos[1], obs["right_team"][opponent][0], obs["right_team"][opponent][1])
...
def close_to_goalkeeper_shot(obs, player_x, player_y):
    ...
    def environment_fits(obs, player_x, player_y):
        ...
        for step in range(15):
            ...
            if get_distance(player_x, player_y, goalkeeper_x, goalkeeper_y) < RUN_SPEED*2:
                return True
        if check_block(obs, player_x, player_y, 1, 0, SHOT_SPEED) and get_distance(player_x, player_y, 1, 0) <= 0.5:
            return True
